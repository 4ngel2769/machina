...
// Export singleton instance that survives multiple module evaluations
const GLOBAL_KEY = Symbol.for('machina.proxyManager');
const globalStore = globalThis;

if (!globalStore[GLOBAL_KEY]) {
  globalStore[GLOBAL_KEY] = new ProxyManager();
}

const proxyManager = globalStore[GLOBAL_KEY];

module.exports = proxyManager;
module.exports.ProxyManager = ProxyManager;
module.exports.default = proxyManager;
